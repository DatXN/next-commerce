...
export const carouselItems: Carousel[] = [
  {
    ...
    alt: 'Save up to 30% on Vitamins & Supplements',
  },
  {
    href: './',
    src: '/assets/carousel/2.webp',
    alt: 'New Arrivals: Natural Beauty Products',
  },
  {
    href: './',
    src: '/assets/carousel/3.webp',
    alt: 'Organic Foods & Snacks Collection',
  },
  {
    href: './',
    src: '/assets/carousel/4.webp',
    alt: 'Sports Nutrition: Build Your Strength',
  },
];
